...
public class ObaAuthentication implements Authentication {
    ...
    @Getter
    private StartbizUserProfilesDetail stb;

    public ObaAuthentication(String username, Set<String> roles, String branchId, String caseId, String appName, StartbizUserProfilesDetail stb) {
        this.name = username;
        this.roles = roles;
